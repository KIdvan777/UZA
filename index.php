...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- All js -->
    <script src="<?php echo get_template_directory_uri() . '/assets/js/uza.bundle.js'; ?>"></script>
    <!-- Active js -->
    <script src="<?php echo get_template_directory_uri() . '/assets/js/default-assets/active.js'; ?>"></script>
